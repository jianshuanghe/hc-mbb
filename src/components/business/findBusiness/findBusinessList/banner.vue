<template>
  <div class="content">
    <div class="contMMBO"  @click="clickFindBusinessDetaile(msgData)">
...
<script>
    ...
    export default {
        ...
        watch: {
          LEAVEMESSAGE: {
            handler (a, b) {
              console.log(a, b, 'vuex数据banner');
              console.log(Number(this.items.instId), Number(b.instrucId), '数据banner');
        ...
        created () {
          ...
          console.log(this.msgData, '子组件bannner获得数据');
          let address = '';
        ...
        methods: {
          ...
          setClickRecord (e, items, evn) {
            ...
            if (e === 'find') { // 查看
              ...
              //       this.$store.commit('setLeaveMessageDoc', this.items.doc); // 更新vuex setLeaveMessageDoc
              //     }
              //   });
              // }
              this.msgData.infoCount = this.msgData.infoCount + 1; // 查看数加一
          ...
          clickFindBusinessDetaile (e) {
            ...
            if (e.type === '1') {
              ...
              if (e.custType === '1') {
                ...
                // tempType = 1 代表进入定制模板
                console.log(this.Rhxherf, 'this.Rhxherf');
