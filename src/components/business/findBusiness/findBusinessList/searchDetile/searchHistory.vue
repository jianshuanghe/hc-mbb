        ...
        <div class="SH-cont">
          ...
          <div class="cont-SH">
            <div class="search-Box-Sh">
              <div class="search-Items left"  v-for="(items, index) in FINDBUSINESS.search.searchHistoryData" :key="index">
    ...
    export default {
        ...
        methods: {
          ...
          clickHistoryList (evn) {
            ...
            this.$store.commit('setFindBusinessSearchText', evn); // 更新vuex setFindBusinessSearchText
