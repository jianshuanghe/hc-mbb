<template>
  <div class="content">
    <div class="goods-box">
      <div class="goods">
        <div class="goods-img left" align="center" v-for="(items, index) in msgData.adveLists" :key="index" @click="clickFindBusinessDetaile(items)">
          <div class="img-box-g">
    ...
    export default {
        ...
        created () {
          ...
          if (this.msgData.typeNames) {
            this.msgData.typeNames = this.msgData.typeNames.split(',');
